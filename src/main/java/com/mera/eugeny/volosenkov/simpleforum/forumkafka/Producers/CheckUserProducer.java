...
@Service
public class CheckUserProducer extends ProducerBase {
    private static final Logger logger = (Logger) LoggerFactory.getLogger(CheckUserProducer.class);
    private static final String TOPIC = "check_user";
    private static final String LOG_HEADER_TEMPLATE = String.format("#### -> %s message", CheckUserProducer.class.getName());

    public CheckUserProducer(@Qualifier("kafkaTemplateLongString") KafkaTemplate<Long, String> kafkaTemplate) {
